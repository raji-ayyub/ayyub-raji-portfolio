    ...
    <div className={`relative w-full transition  px-4 md:px-[12rem] py-[6rem]  `}>
      ...
      <div className= {`flex flex-col gap-6  w-full`}>
        ...
        <div className={`w-full flex justify-between  flex-col md:flex-row`}>
          ...
          <div className={` rounded-2xl mb-4 md:mb-0 relative w-full md:w-[60%]  h-[15rem] md:h-[20rem]`}>
          ...
          <div className={`flex flex-col w-full md:w-[38%] h-[20rem] justify-between gap-2`} >
            ...
            <div className={`w-full h-[9rem]  rounded-2xl`}>
            ...
            <div className={`w-full flex  flex-row  h-[10rem] justify-between overflow-hidden  rounded-2xl`}>
        ...
        <div className={`w-full flex justify-between flex-col md:flex-row`}>
          ...
          <div className={`relative w-full md:w-[60%] rounded-2xl h-[15rem] md:h-[20rem]`}>
